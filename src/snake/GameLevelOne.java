...
public class GameLevelOne extends GameLevelDefaultImpl{
	...
	protected void init() {
		...
		overlapRules.setTotalNbGrains(totalNbGrains);
				...
				snakeH.setPosition(new Point(13 * SPRITE_SIZE, 17 * SPRITE_SIZE));
				universe.addGameEntity(snakeH);
				snakeB.setDriver(snakeDriver);
				snakeB.setPosition(new Point(14 * SPRITE_SIZE, 17 * SPRITE_SIZE));
				universe.addGameEntity(snakeB);
				snakeT.setDriver(snakeDriver);
				snakeT.setPosition(new Point(15 * SPRITE_SIZE, 17 * SPRITE_SIZE));
